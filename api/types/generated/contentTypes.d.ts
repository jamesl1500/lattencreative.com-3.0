...
export interface ApiCaseStudyCaseStudy extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    Metrics: Schema.Attribute.Component<'metric.metrics', false>;
...
export interface ApiNewsletterSubscriptionNewsletterSubscription
  ...
  info: {
    description: 'Email subscriptions for newsletter';
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    processSteps: Schema.Attribute.Component<'process.process-step', true>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiSiteDetailSiteDetail extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    siteFavicon: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    sitekeywords: Schema.Attribute.String;
