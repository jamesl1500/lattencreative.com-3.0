 ...
 */
const fetchServiceById = async (serviceSlug: string): Promise<Service | null> => {
    const data = await fetchFromStrapi(`/services?filters[slug][$eq]=${serviceSlug}&populate=*`);
...
const getServicesData = async (): Promise<Service[]> => {
    ...
    return [
        ...
        },
        {
            ...
            image: "https://images.unsplash.com/photo-1586880244406-556ebe35f282?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1287",
        ...
        },
        {
            ...
            image: "https://images.unsplash.com/photo-1611784728558-6c7d9b409cdf?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=2071",
