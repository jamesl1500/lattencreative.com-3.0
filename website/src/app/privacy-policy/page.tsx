...
export const metadata: Promise<Metadata> = generatePageMetadata({
  ...
  description: "Learn how Latten Creative collects, uses, and protects your personal information. Read our comprehensive privacy policy for complete details.",
            ...
            <div className="page-section-inner container">
              <div className="legal-content">
                ...
                <div className="legal-section">
                  ...
                  <p>
                    Welcome to Latten Creative ("we," "us," or "our"). This Privacy Policy explains how we 
                ...
                <div className="legal-section">
                  ...
                  <p>
                    ...
                    hard drive through your web browser that enables the site's systems to recognize your 
                ...
                <div className="legal-section">
                  ...
                  <ul>
                    ...
                    <li>Communicating with you for customer service, updates, marketing, or promotional purposes</li>
                ...
                <div className="legal-section">
                  ...
                  <p>
                    ...
                    operating our website, conducting our business, or providing services to you, such as:
                  </p>
                  <ul>
                  ...
                  <ul>
                    ...
                    <li>A request from law enforcement or government agencies</li>
                ...
                <div className="legal-section">
                  ...
                  <p>You have the right to request access to the personal information we hold about you and to receive a copy of this information in a portable format.</p>
                  ...
                  <h3>7.3 Erasure</h3>
                  <p>You have the right to request that we delete your personal information under certain circumstances.</p>

                  <h3>7.4 Restriction</h3>
                  <p>You have the right to request that we restrict the processing of your personal information under certain circumstances.</p>
                  ...
                  <p>Where we rely on your consent to process your personal information, you have the right to withdraw that consent at any time.</p>
                ...
                <div className="legal-section">
                  ...
                  <p>
                    ...
                    practices. We encourage you to read their privacy policies before providing any information.
                  </p>
                </div>
                ...
                <div className="legal-section">
                  ...
                  <p>
                    ...
                    data protection laws and that appropriate safeguards are in place to protect your information.
                  </p>
                </div>
                ...
                <div className="legal-section">
                  ...
                  <p>
                    ...
                    changes by posting the updated privacy policy on our website and updating the "Last Updated" 
                ...
                <div className="legal-section">
                  ...
                  <div className="contact-info">
                    <p>
                      ...
                      Website: lattencreative.com<br />
                    </p>
                    <p>
                      For data protection inquiries specifically, you can also contact our Data Protection Officer at: 
