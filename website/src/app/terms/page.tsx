...
export const metadata: Promise<Metadata> = generatePageMetadata({
  ...
  description:
    "Read our terms of service to understand the rules and conditions that govern your use of Latten Creative's website and services.",
  keywords: [
    "terms of service",
    "legal",
    "conditions",
            ...
            <div className="page-section-inner container">
              <div className="legal-content">
                ...
                <div className="legal-section">
                  ...
                  <p>
                    Welcome to Latten Creative ("we," "us," or "our"). These
                    Terms of Service ("Terms") govern your use of our website
                    located at lattencreative.com and our services
                ...
                <div className="legal-section">
                  ...
                  <p>
                    ...
                    the materials on Latten Creative's website for personal,
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      contained on Latten Creative's website;
                    </li>
                    <li>
                  ...
                  <p>
                    ...
                    any of these restrictions and may be terminated by Latten
                    Creative at any time. Upon terminating your viewing of these
                ...
                <div className="legal-section">
                  <h2>4. Services</h2>
                  <p>
                    Latten Creative provides web design, web development,
                    digital marketing, and related digital services. All
                    services are subject to availability and may be modified or
                    discontinued at any time without notice.
                  </p>
                  <p>
                    Service agreements are established through separate
                    contracts or statements of work, which will include specific
                    terms, deliverables, timelines, and payment terms for each
                    project.
                  </p>
                </div>
                ...
                <div className="legal-section">
                  ...
                  <p>
                    ...
                    responsible for Content that you post to the Service,
                    including its legality, reliability, and appropriateness.
                  </p>
                  <p>
                    By posting Content to the Service, You represent and warrant
                    that:
                  </p>
                  <ul>
                    <li>
                      Content is yours (you own it) and/or you have the right to
                      use it
                    </li>
                    <li>
                      Content does not infringe, violate or misappropriate the
                ...
                <div className="legal-section">
                  ...
                  <p>
                    ...
                    Latten Creative and its licensors. The Service is protected
                ...
                <div className="legal-section">
                  ...
                  <p>
                    In no event shall Latten Creative or its suppliers be liable
                    ...
                    Latten Creative's website, even if Latten Creative or a
                    Latten Creative authorized representative has been notified
                ...
                <div className="legal-section">
                  ...
                  <p>
                    The materials appearing on Latten Creative's website could
                    include technical, typographical, or photographic errors.
                    Latten Creative does not warrant that any of the materials
                    on its website are accurate, complete or current. Latten
                    Creative may make changes to the materials contained on its
                    website at any time without notice. However Latten Creative
                ...
                <div className="legal-section">
                  <h2>13. Links</h2>
                  <p>
                    Latten Creative has not reviewed all of the sites linked to
                    our website and is not responsible for the contents of any
                    such linked site. The inclusion of any link does not imply
                    endorsement by Latten Creative of the site. Use of any such
                ...
                <div className="legal-section">
                  ...
                  <p>
                    Latten Creative may revise these terms of service for its
                ...
                <div className="legal-section">
                  ...
                  <p>
                    ...
                    accordance with the laws of the jurisdiction in which Latten
                    Creative operates and you irrevocably submit to the
