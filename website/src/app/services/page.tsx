...
export const metadata: Promise<Metadata> = generatePageMetadata({
  title: "Our Services",
  description:
    "Explore our comprehensive range of digital services designed to help your business grow. From web design to digital marketing, we have the expertise to transform your online presence.",
  keywords: [
    "services",
    "web design",
    "web development",
          ...
          <div className="page-section page-section-overview">
            <div className="page-section-inner container">
              <div className="page-section-title text-center">
                <h2>What We Do</h2>
                <p>
                  Discover how our expert services can transform your digital
                  presence
                </p>
              </div>
              <div className="services-overview-grid">
                <div className="overview-item">
                  ...
                  <p>
                    Beautiful, user-centered designs that capture your brand
                ...
                <div className="overview-item">
                  ...
                  <p>
                    Cutting-edge web solutions built with modern technologies
                ...
                <div className="overview-item">
                  ...
                  <p>
                    Strategic digital marketing campaigns that drive traffic,
            ...
            <div className="page-section-inner container">
              ...
              <div className="why-choose-grid">
                <div className="why-choose-item">
                  ...
                  <p>
                    Years of experience and hundreds of successful projects
                ...
                <div className="why-choose-item">
                  ...
                  <p>
                    Tailored approaches that fit your unique business needs and
                    goals.
                  </p>
                </div>
                <div className="why-choose-item">
                  ...
                  <h3>Fast Delivery</h3>
                  <p>
                    Efficient project management ensures timely delivery without
                ...
                <div className="why-choose-item">
                  ...
                  <p>
                    Continuous support and maintenance to keep your digital
                    assets performing optimally.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="page-section page-section-cta">
            <div className="page-section-inner container">
              <div className="cta-content">
                ...
                <p>
                  Let's discuss your project and find the perfect service
