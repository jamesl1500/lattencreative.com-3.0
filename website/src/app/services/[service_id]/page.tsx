            ...
            <div className="pricing-grid">
              <div className="pricing-card">
                <div className="pricing-header">
                  <h3>{service.pricing.basic.name}</h3>
                  <div className="pricing-price">{service.pricing.basic.price}</div>
                </div>
                ...
                <Link href="/contact-us" className="btn btn-secondary pricing-btn">
                  Get Started
                </Link>
              </div>
              ...
              <div className="pricing-card pricing-card-featured">
                ...
                <div className="pricing-header">
                  <h3>{service.pricing.professional.name}</h3>
                  <div className="pricing-price">{service.pricing.professional.price}</div>
                </div>
                <ul className="pricing-features">
                ...
                <Link href="/contact-us" className="btn btn-primary pricing-btn">
                  Get Started
                </Link>
              </div>
              ...
              <div className="pricing-card">
                <div className="pricing-header">
                  <h3>{service.pricing.enterprise.name}</h3>
                  <div className="pricing-price">{service.pricing.enterprise.price}</div>
                </div>
                <ul className="pricing-features">
          ...
          <div className="service-section-inner">
            <div className="testimonial-content">
              <div className="testimonial-quote">
                <blockquote>"{service.testimonial.quote}"</blockquote>
              </div>
              <div className="testimonial-author">
                <h4>{service.testimonial.author}</h4>
                <p>{service.testimonial.position}, {service.testimonial.company}</p>
              </div>
            </div>
          </div>
        </section>
